...
// (1) Define a data class for “feature” items
class AboutFeature {
  final IconData icon;
  final String title;
...
// (2) Define a data class for “impact” stats
...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Sample i18n‐like strings (in the React code, these come from t(...) )
    // Replace with your actual translations or strings.
    ...
    // (3) “Features” array (mimics React’s t("about.features.items"))
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Feature label with an icon
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.shield, color: Colors.cyan[200], size: 28),
                      ...
                      return Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Icon(feat.icon, size: 48, color: Colors.cyan[600]),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Your support helps us expand our network,\nenhance real-time monitoring, and save lives.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
